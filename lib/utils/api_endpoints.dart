class ApiEndPoints {
  static String baseUrl =
      "https://app-api-vpro-ft-fasttopup.milliekit.com/api/reseller/";

  static String publicUrl =
      "https://app-api-vpro-ft-fasttopup.milliekit.com/api/public/";

  // static String baseUrl = "https://app-api-vpro-mt.milliekit.com/api/reseller/";
  // static String publicUrl = "https://app-api-vpro-mt.milliekit.com/api/public/";
